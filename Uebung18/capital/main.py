...
class MainHandler(BaseHandler):
    def get(self):
        ...
        message2 = "who dat"
        return self.render_template("hello.html", params={"message": message, "message2": message2})


class ClockHandler(BaseHandler):
    def get(self):
        clocktime = datetime.datetime.now().time()
        return self.render_template("clock.html", params={"clocktime": clocktime})


# URLs
app = webapp2.WSGIApplication([
    webapp2.Route('/', MainHandler),
    webapp2.Route('/clock', ClockHandler)
], debug=True)
