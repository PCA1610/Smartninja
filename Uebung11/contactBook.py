...
class Contact:
    ...
    def get_age(self):
        current_year_full = int(datetime.now().year)
        return current_year_full - self.birth_year
...
def edit_contact(contacts):
    ...
    new_mail = raw_input("Please enter a new mail address fpr %s: " % selected_contact.get_full_name())
    selected_contact.email = new_mail
